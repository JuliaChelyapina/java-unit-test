...
public class CheckIsAdultTest {
  ...
  public static Object[][] getTextData() {
    return new Object[][] {
        ...
        {19, true},
        {17, false},
        {18, true},// Заполни массив тестовыми данными и ожидаемым 
результатом
    };
  }
  ...
  public void checkIsAdultWhenAgeThenResult() {
    ...
    // Сравни полученный и ожидаемый результаты, не забудь про сообщение 
об ошибке
    assertEquals("возраст >= 18", result, isAdult);
    }
}
